...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/28 15:55:11 by sdestann          #+#    #+#             */
/*   Updated: 2023/04/11 16:55:49 by sdestann         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_print_i(char *nbstr, int n, t_flags flags)
{
	...
	count = 0;
	if (n < 0 && (flags.zero == 0 || flags.precision >= 0))
		count += ft_print_c('-');
	...
	if (flags.precision >= 0)
		count += ft_pad_width(flags.precision -1, ft_strlen(nbstr) - 1, 1);
